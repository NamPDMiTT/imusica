                                    ...
                                    <form action="{{ getAdminPanelUrl() }}/enrollments/store" method="Post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="webinar_id" class="form-control search-webinar-select2"
                                                    data-placeholder="{{trans('admin/main.search_class')}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="user_id" class="form-control search-user-select2" data-placeholder="{{ trans('admin/main.search_users') }}">
