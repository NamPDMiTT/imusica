            ...
            <div class="course-content-sidebar col-12 col-lg-4 mt-25 mt-lg-0">
                <div class="rounded-lg shadow-sm">
                    <div class="course-img {{ $course->video_demo ? 'has-video' : '' }}">
                        ...
                        {{-- Check trong chuỗi $course->video_demo có chứa youtube không --}}
                        @php $isYoutube = strpos($course->video_demo, 'youtube') @endphp
                            @if ($course->video_demo_source == 'youtube' || $isYoutube)
                                <div data-video-path="{{ $course->video_demo }}"
                                    ...
                                    @php
                                        $videoId = explode('=', $course->video_demo);
                                        $videoId = end($videoId);
                        ...
                        @if (!empty($course->access_days))
                            <div class="mt-20 d-flex align-items-center justify-content-between text-gray">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span
                                        class="ml-5 font-14 font-weight-500">{{ trans('update.access_period') }}:</span>
                                </div>
